...
export class ConfigService {
  ...
  private _authority_url = this._api_url + '/authority';

  private _authorities_url = this._authority_url + '/all';
  ...
  get authority_url(): string {
    return this._authority_url;
  }

  get authorities_url(): string {
    return this._authorities_url;
  }
}
